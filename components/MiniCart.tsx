...
import {SelectedVariant} from "./ProductForm";
...
export default function MiniCart({cart}: MiniCartProps): JSX.Element {
								...
								<div className="flex-1 py-6 overflow-y-auto px-4 sm:px-6">
									...
									<div className="mt-8">
										<div className="flow-root">
											{cart.length ? <ul role="list" className="-my-6 divide-y divide-gray-200">
												{cart.map((product) => (
												<li key={product.id} className="py-6 flex">
													<div
													className="relative flex-shrink-0 w-24 h-24 border border-gray-200 rounded-md overflow-hidden">
														<Image
														layout="fill"
														objectFit="cover"
														src={product.image!}
